...
$math_Info = $db->query("SELECT * FROM lessons WHERE lessonType= 'Matematik' AND lessonID= '{$lessonNo}' AND lessonLevel = '{$school_level}'")->fetch(PDO::FETCH_ASSOC);
$listInfo = json_encode($math_Info); 

$math_lesson = $db->query("SELECT * FROM questions WHERE lessonType='Matematik' AND lessonID='{$lessonNo}' AND questionLevel = '{$school_level}'")->fetchAll(PDO::FETCH_ASSOC);
$listQuestion = json_encode($math_lesson); 
...
<head>
    ...
    <title>Ders <?php echo $lessonNo?> | Matematik ~ Codingo</title>
...
<body>
    ...
    <div class="info">
        <div class="area">
            ...
            <div class="infoHeader">Matematik <?php echo $lessonNo?>. Ders Bilgilerdirme Yazısı</div>
        ...
        <div class="newNote">
            <div class="head">
                <div class="close-Popup">
                    ...
                    <path id="colorSvg" d="M24 9.4L22.6 8L16 14.6L9.4 8L8 9.4L14.6 16L8 22.6L9.4 24L16 17.4L22.6 24L24 22.6L17.4 16L24 9.4Z" fill="black"/>
                    </svg>
                </div>
...
<script>
    ...
    $(sendNote).on("click",()=>{
        ...
        if(note==""){
            ...
            let date = "Matematik " + lessonNo + ". Ders"
            $.ajax({
                    type:"POST",
                    url:"./newNote.php",
                    data: {
...
<script type="module">
    ...
    if(Decryption(localStorage.getItem("theme")) == "darkTheme"){
        $("#colorSvg").attr("fill","white")
    }
</script>
</body>
</html>